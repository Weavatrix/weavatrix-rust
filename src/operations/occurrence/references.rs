...
pub(super) fn find_references(state: &RepositoryState, args: &Value) -> Result<Value, String> {
...
pub(super) fn unresolved(query: &Query, loaded: Option<&scip::Loaded>, reason: &str) -> Value {
    json!({
        "state": "UNRESOLVED",
