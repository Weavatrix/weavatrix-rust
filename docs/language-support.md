...
| YAML / Kubernetes | documents, deployment resources, services, workloads, images, ports, and configuration links; after parse, Dify DSL is a domain, not a second `.yml` adapter |
